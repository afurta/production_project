...
export const getArticlePageLoading = (state: StoreSchema) =>
  state.ArticlesPage?.isLoading
export const getArticlePageView = (state: StoreSchema) =>
  state.ArticlesPage?.view || ArticleView.LIST
export const getArticlePageLimit = (state: StoreSchema) =>
  state.ArticlesPage?.limit || 9
export const getArticlePageHasMore = (state: StoreSchema) =>
  state.ArticlesPage?.hasMore
export const getArticlePageNum = (state: StoreSchema) =>
...
export const getArticlePageSortField = (state: StoreSchema) =>
  state.ArticlesPage?.sortField ?? ArticleSortFields.CREATED_AT
export const getArticlePageSortOrder = (state: StoreSchema) =>
