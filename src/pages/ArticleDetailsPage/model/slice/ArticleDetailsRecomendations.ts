...
export const getRecomendationsArticleSelectors =
  recomendationsAdapter.getSelectors<StoreSchema>(
    (state) =>
      state.ArticlesDetailsPage?.recomendations ||
...
export const ArticleDetailsPageRecomendations = createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(fetchRecomendationArticle.pending, (state) => {
      ...
      builder.addCase(
        fetchRecomendationArticle.fulfilled,
...
export const { actions: ArticleDetailsPageRecomendationsActions } =
  ArticleDetailsPageRecomendations
